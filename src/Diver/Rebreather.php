...
final class Rebreather implements XmlSerializable
{
    public function __construct(
        ...
        /** @var EquipmentPiece[] */
        public readonly array $o2Sensors = [],
    ) {}
    ...
    public function toXml(\DOMDocument $doc): \DOMElement
    {
        ...
        $el = $piece->toXml($doc, 'rebreather');

        foreach ($this->o2Sensors as $sensor) {
            $el->appendChild($sensor->toXml($doc, 'o2sensor'));
        }
